 ...
 */
public class DCRMDataHolder {

    private static DCRMDataHolder thisInstance = new DCRMDataHolder();
    private ApplicationManagementService applicationManagementService = null;

    private DCRMDataHolder() {
    }

    public static DCRMDataHolder getInstance() {
        return thisInstance;
    }
